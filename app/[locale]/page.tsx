      ...
      <section className="relative h-screen w-full flex flex-col justify-center items-center px-6">
        <div className="absolute inset-0 z-0">
          <img
            ...
            className="w-full h-full object-cover opacity-90 grayscale-[0.5] contrast-[1]"
          />
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-10">
          <div className="inline-block">
            ...
            <div className="w-8 h-px bg-white-200 mx-auto mt-4"></div>
          </div>

          <h1 className="text-5xl md:text-7xl font-logo font-light leading-tight tracking-tight text-white">
            {content.title}
          </h1>
          <p className="text-base md:text-lg text-white max-w-lg mx-auto leading-relaxed font-light italic">
            {content.subtitle}
          </p>
          <div className="flex flex-col sm:flex-row gap-8 items-center justify-center pt-6">
            <Link href={user ? "/trips" : "/auth/signin"}>
              <button className="text-[11px] uppercase tracking-[0.3em] font-bold text-white border-b border-white pb-2 hover:opacity-50 transition-all duration-300">
                {content.getStarted}
              </button>
            </Link>
          </div>
      ...
      <section className="py-40 px-6">
        <div className="max-w-2xl mx-auto text-center space-y-8">
          ...
          <Link href={user ? "/trips/new" : "/auth/signin"} className="inline-block group">
            ...
            <div className="h-px bg-neutral-950 w-full mt-1"></div>
          </Link>
        </div>
      </section>
    </div>
