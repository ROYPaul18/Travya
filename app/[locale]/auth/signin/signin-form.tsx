            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="space-y-1">
                                    ...
                                    <FormControl>
                                        <Input type="email" placeholder="votre@email.com" className={inputStyle} {...field} />
                                    </FormControl>
                    ...
                    <Button
                        ...
                        className="w-full bg-black hover:bg-neutral-800 text-white text-[11px] font-bold uppercase tracking-[0.2em] rounded-none h-14 flex items-center justify-center gap-2 transition-all mt-10 shadow-lg"
                    >
                        {form.formState.isSubmitting ? <Loader2 className="h-4 w-4 animate-spin" /> : "Se connecter"}
                    </Button>
                </form>
            </Form>
